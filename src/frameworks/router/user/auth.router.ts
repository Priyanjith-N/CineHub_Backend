...
import AuthController from '../../../adapters/controllers/user/auth.controller';
import AuthUseCase from '../../../usecase/user/auth.usecase';
import AuthRepository from '../../../adapters/repositories/user/auth.repositories';
...
// interfaces
import { IAuthController } from '../../../interface/controllers/user/IAuth.controller';
